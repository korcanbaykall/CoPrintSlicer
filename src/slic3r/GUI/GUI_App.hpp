...
enum CoPrintSlicerMenuIDs {
  CoPrintSlicerMenuAbout,
  CoPrintSlicerMenuPreferences,
};
...
public:
    ...
    std::string logo_name() const { return is_editor() ? "CoPrintSlicer" : "CoPrintSlicer-gcodeviewer"; }
