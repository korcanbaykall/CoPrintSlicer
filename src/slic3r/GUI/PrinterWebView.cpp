...
PrinterWebView::PrinterWebView(wxWindow *parent)
        : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
 {
    ...
    preview_bottom_panel->SetMinSize(wxSize(-1, FromDIP(40)));
    preview_bottom_panel->SetMaxSize(wxSize(-1, FromDIP(40)));
    auto *preview_bottom_row = new wxBoxSizer(wxHORIZONTAL);
    preview_bottom_row->AddSpacer(FromDIP(20));
    ...
    preview_bottom_panel->SetSizer(preview_bottom_row);
