...
PrinterWebView::PrinterWebView(wxWindow *parent)
        : wxPanel(parent, wxID_ANY, wxDefaultPosition, wxDefaultSize)
 {
    ...
    preview_bottom_row->AddStretchSpacer(1);
    auto *play_icon = new wxStaticBitmap(preview_box, wxID_ANY, create_scaled_bitmap("play", this, 18));
    preview_bottom_row->Add(play_icon, 0, wxALIGN_CENTER_VERTICAL);
    preview_bottom_row->AddStretchSpacer(1);
    preview_box_sizer->Add(preview_bottom_row, 1, wxEXPAND);
