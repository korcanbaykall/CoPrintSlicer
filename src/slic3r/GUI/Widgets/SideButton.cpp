    ...
    , state_handler(this)
{
    ...
    border_color.append(wxColour(184, 134, 0), StateColor::Pressed);
    border_color.append(wxColour(230, 180, 50), StateColor::Hovered);
    border_color.append(0xE6A800, StateColor::Normal);  // CoPrintSlicer yellow
    ...
    background_color.append(wxColour(184, 134, 0), StateColor::Pressed);
    background_color.append(wxColour(230, 180, 50), StateColor::Hovered);
    background_color.append(0xE6A800, StateColor::Normal);  // CoPrintSlicer yellow
