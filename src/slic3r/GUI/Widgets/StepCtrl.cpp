...
StepCtrlBase::StepCtrlBase(wxWindow *      parent,
    ...
    , clr_bar(0xACACAC)
    , clr_step(0xACACAC)
    , clr_text(std::make_pair(0xE6A800, (int) StateColor::Checked),  // CoPrintSlicer yellow
    ...
    , bmp_ok(this, "step_ok", 12)
{
    ...
    clr_step = StateColor(
            ...
            std::make_pair(0xE6A800, 0));  // CoPrintSlicer yellow
    clr_text = StateColor(
            std::make_pair(0xACACAC, (int) StateColor::Disabled),
...
void FilamentStepIndicator::doRender(wxDC& dc)
{
    ...
    dc.SetTextForeground(wxColour(230, 168, 0));  // CoPrintSlicer yellow
    int circleX = 20;
    int circleY = 20;
