    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
   ...
   // m_sizer_main->Add(m_basic_panel, 0, wxEXPAND | wxLEFT | wxRIGHT, FromDIP(15));
    ...
    {//new content//tip confirm ok button
        ...
        m_more_setting_tips->SetForegroundColour(wxColour(230, 168, 0)); // yellow for device screen
        ...
        StateColor btn_bg_green(std::pair<wxColour, int>(wxColour(184, 134, 0), StateColor::Pressed), std::pair<wxColour, int>(wxColour(230, 168, 0), StateColor::Hovered),
                                std::pair<wxColour, int>(wxColour(230, 168, 0), StateColor::Normal)); // yellow for device screen
...
void SyncAmsInfoDialog::Enable_Auto_Refill(bool enable)
{
    ...
    if (enable) {
        m_ams_backup_tip->SetForegroundColour(wxColour("#E6A800"));
    } else {
