...
static const std::string VERSION_CHECK_URL = "https://check-version.coprintslicer.com/latest";
static const std::string PROFILE_UPDATE_URL = "https://api.github.com/repos/CoPrintSlicer/coprintslicer-profiles/releases/tags";
