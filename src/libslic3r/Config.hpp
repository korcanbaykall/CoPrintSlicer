...
// When parsing a configuration value, if the old_value is not understood by this CoPrintSlicer version,
// it is being substituted with some default value that this CoPrintSlicer could work with.
