...
#define SLIC3R_APP_FULL_NAME "CoPrintSlicer"
#define GCODEVIEWER_APP_NAME "CoPrintSlicer G-code Viewer"
#define GCODEVIEWER_APP_KEY  "CoPrintSlicerGcodeViewer"
#define GCODEVIEWER_BUILD_ID std::string("CoPrintSlicer G-code Viewer-") + std::string(SLIC3R_VERSION) + std::string("-RC")
